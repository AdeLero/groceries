...
class _LandingPageState extends State<LandingPage> {
  ...
  final mealPlan = finalMealPlan.value;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (mealPlan != null && mealPlan.isNotEmpty)
                    SizedBox(
                      height: 150,
                      child: ValueListenableBuilder(
                          valueListenable: finalMealPlan,
                          builder: (context, plannedMeals, child) {
                            return ListView.builder(
                              scrollDirection: Axis.horizontal,
                              itemCount: finalMealPlan.value.length,
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      '${mealPlan[index].servings.toString()} servings',
                                                      style: TextStyle(
                                                          color: Colors.white,
                                                          fontSize: 8),
                                                    ),
